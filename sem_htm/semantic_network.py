...
surface_layer1 = network_factory.create_htm_instance('surface_layer')
surface_layer2 = network_factory.create_htm_instance('surface_layer')

abstract_layer = network_factory.create_htm_instance('abstract_layer')
